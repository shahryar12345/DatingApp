...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase 
    {
        ...
        public MessagesController(IDatingRepositor repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> GetMessageThread(int userId , int recipientId)
        {
            ...
            var messageFromRepo = await _repo.GetMesssageThread(userId , recipientId);

            var messgaeThread = _mapper.Map<IEnumerable<MessageToReturnDto>>(messageFromRepo);
